...
Система представляет из себя своего рода конструктор, пока ещё разобранный на блоки. Процесс сборки начинается с оформления файлов _index_.html и _style_.css, с добавления в них содержимого блоков.
